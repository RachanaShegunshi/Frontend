    ...
    <div className="container mb-5 mt-3">
      <div className="row d-flex align-items-baseline">
        <div className="col-xl-9">
          <p style={{color: '#7e8d9f', fontSize: 20}}>Invoice &gt;&gt; <strong>ID: #123-123</strong></p>
        </div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-xl-8">
            <ul className="list-unstyled">
              ...
              <li className="text-muted"><i className="fas fa-phone" /> 123-456-789</li>
            </ul>
          </div>
          <div className="col-xl-4">
            <p className="text-muted">Invoice</p>
            <ul className="list-unstyled">
              <li className="text-muted"><i className="fas fa-circle" style={{color: '#84B0CA'}} /> <span className="fw-bold">ID:</span>#123-456</li>
              <li className="text-muted"><i className="fas fa-circle" style={{color: '#84B0CA'}} /> <span className="fw-bold">Creation Date: </span>Jun 23,2021</li>
        ...
        <div className="row">
          ...
          <div className="col-xl-3">
            ...
            <p className="text-black float-start"><span className="text-black me-3"> Total Amount</span><span style={{fontSize: 25}}>1221</span></p>
          </div>
        </div>
        <hr />
        <div className="row">
          ...
          <div className="col-xl-2">
            <button type="button" data-mdb-button-init data-mdb-ripple-init className="btn btn-primary text-capitalize" style={{backgroundColor: '#60bdf3'}}>Pay Now</button>
          </div>
        </div>
      </div>
    </div>
